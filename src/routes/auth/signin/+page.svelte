<script lang="ts">
	...
	const appName = env.PUBLIC_APP_NAME || "Chat UI";
	const appDescription = env.PUBLIC_APP_DESCRIPTION || "Sign in to continue";
		...
		<div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-6">
			...
			<div class="space-y-4">
				...
				<button
					...
					class="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
				>
				...
				<button
					...
					class="w-full flex items-center justify-center gap-3 px-6 py-3 bg-gray-900 dark:bg-gray-700 border-2 border-gray-900 dark:border-gray-600 text-white rounded-lg hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
				>
